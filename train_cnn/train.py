...
# Low-Range Hyperparameter Experiments

# Parameter ranges:
#   learning_rate          : 0.00001 – 0.00005
#   gamma                  : 0.90 – 0.93
#   batch_size             : 16 – 32
#   exploration_initial_eps: 0.8 – 1.0
#   exploration_final_eps  : 0.01 – 0.05
#   exploration_fraction   : 0.05 – 0.20
...
EXPERIMENTS = {
    ...
    5: dict(
        ...
        exploration_fraction=0.10,
        notes="Lower eps_end — more exploitation late game",
    ),
    6: dict(
        ...
        notes="Faster decay — exploitation kicks in early",
    ),
    7: dict(
        ...
        notes="Slower decay — longer exploration phase",
    ),
    8: dict(
        name="exp8_mixed_low",
        ...
        exploration_fraction=0.10,
        notes="Mixed low — observe combined effect",
    ),
    9: dict(
        ...
        notes="Moderate decay — balanced explore/exploit",
    ),
    10: dict(
        ...
        exploration_fraction=0.10,
        notes="Best-of-low — final low-range candidate",
    ),
}
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train DQN (CNNPolicy) on ALE/Seaquest-v5 — Member 1"
    )
...
# Next step is to increse number of steps to 5M-10M for exp 5 -10 and retrain for better learning.